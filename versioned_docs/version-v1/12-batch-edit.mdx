...
![Import from miz picture](/img/batch-1.png)
...
![Editing batch data](/img/batch-2.png)

There is some input validation that should help guide the editing process.

![Editing validation example](/img/batch-3.png)
...
![Download CSV button](/img/batch-4.png)
...
![Import in sheets](/img/batch-6.png)

Select the import method of your choice:

![Import method example](/img/batch-8.png)

Edit the fields as required. Be sure to preserve the column names:

![Example of data in the sheet](/img/batch-9.png)
...
![Download as CSV](/img/batch-10.png)
...
![Batch edit job example](/img/batch-12.png)