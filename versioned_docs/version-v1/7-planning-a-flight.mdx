...
![Planner discord auth](/img/plan-1.png)
...
![Planning mode waypoints](/img/plan-2.png)
...
![Edit waypoint details](/img/plan-4.png)
...
![Waypoint drop mode](/img/plan-5.png)
...
![In-game screenshot of waypoint data](/img/plan-6.png)
...
![Screenshot of the edit dialog](/img/plan-12.png)
...
![Planning toggle interaction on the feature hopup](/img/np_1.png)
...
![Nav point drag and drop interaction](/img/np_2.png)

To add a new Navigation Target Point, click the Add Nav Target Point button:

![Add nav target point button](/img/np_3.png)
...
![Multi-line text example](/img/np_4.png)
...
![Radio preset input for planners](/img/plan-7.png)
...
![Preset import dropdown](/img/plan-8.png)
...
![Example laser code input](/img/plan-9.png)
...
![Example notes input](/img/plan-10.png)

Example lineup card kneeboard:

![Example notes lineup card result](/img/plan-11.png)
...
![Fuel planner image](/img/plan-13.png)
...
![Lineup card fuel plan](/img/plan-14.png)

The planner will also appear on the group data window, with inputs disabled:

![Group Data window fuel plan](/img/plan-15.png)